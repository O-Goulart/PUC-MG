...
public class Main {
    ...
    public static int comparar(Restaurante r1, Restaurante r2) {
        comparacoes++;
        Data d1 = r1.getData_abertura();
        Data d2 = r2.getData_abertura();
    ...
    public static void sort(Restaurante[] array, int n) {
    ...
    public static void main(String[] args) {
        ...
        if (numSelecionados > 0) {
            sort(selecionados, numSelecionados);
        }
        ...
        try {
            FileWriter log = new FileWriter("855217_heapsort.txt");
            log.write("855217\t" + comparacoes + "\t" + movimentacoes + "\t" + tempoExecucao + "\n");
            log.close();
        } catch (IOException e) {
